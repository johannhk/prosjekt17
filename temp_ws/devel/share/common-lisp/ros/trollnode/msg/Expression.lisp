...
(cl:ensure-generic-function 'look-val :lambda-list '(m))
(cl:defmethod look-val ((m <Expression>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trollnode-msg:look-val is deprecated.  Use trollnode-msg:look instead.")
  (look m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Expression>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'look))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'look))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Expression>) istream)
  "Deserializes a message object of type '<Expression>"
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'look) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'look) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Expression>)))
  ...
  "c4b0b66f4e8edc3a85581ccec469d88c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Expression)))
  "Returns md5sum for a message object of type 'Expression"
  "c4b0b66f4e8edc3a85581ccec469d88c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Expression>)))
  ...
  (cl:format cl:nil "string speech		#The troll will say this out loud. Write normal english.~%string expression 	#shortform for the expression, like angry, smile, etc. ~%string look			#where the troll should look. left, right, up, down~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Expression)))
  "Returns full string definition for message of type 'Expression"
  (cl:format cl:nil "string speech		#The troll will say this out loud. Write normal english.~%string expression 	#shortform for the expression, like angry, smile, etc. ~%string look			#where the troll should look. left, right, up, down~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Expression>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'look))
))
