#ifndef __EXPRESSION_TEMPLATES_H_INCLUDED__
#define __EXPRESSION_TEMPLATES_H_INCLUDED__
...
//map to translate the expression action values to strings accepted by the trollface
static std::map<int, std::string> actionValueToActionName {
